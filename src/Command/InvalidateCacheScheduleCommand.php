...
use Effiana\CacheBundle\Action\DataStorage\InvalidateCacheDataStorage;
use Effiana\CacheBundle\Action\Handler\InvalidateCacheActionHandlerInterface;
use Effiana\CacheBundle\Action\Handler\InvalidateCacheActionScheduledHandler;
...
{
    const NAME = 'effiana:cache:invalidate:schedule';
